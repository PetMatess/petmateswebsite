...
<header class="header">
    ...
    background-color: rgb(255, 210, 217);">
        ...
        <div class="container backfont">
            <div class="container">
                <a href="<?php echo 'Breed_detailw.php?pet_breeds_info=dog'?>" >
                ...
                <section class="mx-auto my-5" style="max-width: 23rem;">
                    <a href="<?php echo 'Breed_detailw.php?pet_breeds_info=cat'?>">
                    <div class="card" style="background-color: #f5f7fa;">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                ...
                <section class="mx-auto my-5" style="max-width: 23rem;">
<a href="<?php echo 'Breed_detailw.php?pet_breeds_info=bird'?>">
                    <div class="card" style="background-color: #f5f7fa;">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
            ...
            <div class="container">
                <section class="mx-auto my-5" style="max-width: 23rem;">
 <a href="<?php echo 'Breed_detailw.php?pet_breeds_info=fish'?>">
                    <div class="card" style="background-color: #f5f7fa;">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
